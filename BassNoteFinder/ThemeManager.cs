...
public static class ThemeManager
{
    ...
    private static IReadOnlyDictionary<string, Color> CreateDarkPalette()
    {
        return new Dictionary<string, Color>
        {
            ...
            ["CorrectFeedbackBackgroundBrush"] = Parse("#173D27"),
            ["ErrorFeedbackBackgroundBrush"] = Parse("#4B201D"),
    ...
    private static IReadOnlyDictionary<string, Color> CreateLightPalette()
    {
        return new Dictionary<string, Color>
        {
            ...
            ["CorrectFeedbackBackgroundBrush"] = Parse("#E2F4E6"),
            ["ErrorFeedbackBackgroundBrush"] = Parse("#FDE8E6"),
